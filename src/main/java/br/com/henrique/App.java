...
public class App implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Mesa m4 = new Mesa(null,"Mesa004");
        m4.setStatus(StatusMesa.OCUPADA);
        Mesa m5 = new Mesa(null,"Mesa005");
        mesaRepository.saveAll(Arrays.asList(m,m2,m3,m4,m5));
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm");
        Pedido ped1= new PedidoComum(null,sdf.parse("01/02/2019 10:32"),u2,m,u);
        ...
        Pedido ped2= new PedidoComum(null,sdf.parse("05/02/2019 11:12"),u3,m2,u2);
        ItemPedido i3 = new ItemPedido(ped2,p1,1);
        ItemPedido i4 = new ItemPedido(ped2,p2,1);
        ped2.getItens().add(i3);
        ped2.getItens().add(i4);
        ped2.calculaTotal();

        Pedido ped3= new PedidoComum(null,sdf.parse("10/02/2019 11:12"),u3,m3,u2);
        ItemPedido i5 = new ItemPedido(ped3,p1,3);
        ItemPedido i6 = new ItemPedido(ped3,p5,1);
        ped3.getItens().add(i5);
        ped3.getItens().add(i6);
        ped3.calculaTotal();

        Pedido ped4= new PedidoComum(null,sdf.parse("15/02/2019 11:12"),u3,m4,u2);
        ItemPedido i7 = new ItemPedido(ped4,p8,1);
        ItemPedido i8 = new ItemPedido(ped4,p7,4);
